...
insert into public.prompts (
  ...
  'professional corporate team portrait of {{team_size}} colleagues, shot on a real DSLR camera, modern office background with soft depth blur, bright even lighting, natural skin texture with visible pores, authentic asymmetric expressions, individual hair strands, confident friendly poses, unretouched real-photo quality, no airbrushing, no cgi, no plastic skin, business casual attire, high-end corporate photography, natural group composition with clear individual detail', 'بورتريه احترافي لفريق عمل مكوّن من {{team_size}}، مصورة بكاميرا DSLR حقيقية، خلفية مكتب عصري بضبابية ناعمة، إضاءة ساطعة متساوية، ملمس بشرة طبيعي بمسام ظاهرة، تعبيرات عفوية غير متناظرة تماماً، خصل شعر فردية، وضعيات واثقة وودية، جودة صورة حقيقية غير مُنعّمة، بدون تنعيم مصطنع، بدون CGI، بدون مظهر بلاستيكي، زي عمل غير رسمي، تصوير مؤسسي راقٍ، تكوين جماعي طبيعي مع وضوح تفاصيل كل فرد',
